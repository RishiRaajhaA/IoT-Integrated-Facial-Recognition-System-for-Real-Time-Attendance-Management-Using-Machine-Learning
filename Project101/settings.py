...
ALLOWED_HOSTS = ['*']  # In production, replace with specific domain/IP
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'Project101', 'static')]



# Media files (uploads like student photos, etc.)
MEDIA_URL = '/media/'
